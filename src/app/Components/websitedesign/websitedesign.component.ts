...
export class WebsitedesignComponent implements OnInit {
  ...
  list2 = [{ id: "1", img: "assets/Frame12.png" }, { id: "2", img: "assets/Frame13.png" }, { id: "3", img: "assets/Frame14.png" }, { id: "4", img: "assets/Frame15.png" }, { id: "5", img: "assets/Frame16.png" }, { id: "6", img: "assets/Frame17.png" }, { id: "7", img: "assets/Frame18.png" }, { id: "8", img: "assets/Frame19.png" }, { id: "9", img: "assets/Frame20.png" }]
  ...
  list: string[] = ["assets/Frame12.png", "assets/Frame13.png", "assets/Frame14.png", "assets/Frame15.png", "assets/Frame16.png", "assets/Frame17.png", "assets/Frame18.png", "assets/Frame19.png", "assets/Frame20.png"]
  ...
  left() {
    ...
    if (this.intervalCounterView < this.list.length) {
      this.interLeft = window.setInterval(() => {
        this.scroller.nativeElement.style.marginRight = `${this.intervalCounter}vw`;
  ...
  right() {
    ...
    if (this.intervalCounterView > 3) {
      this.interRight = window.setInterval(() => {
        this.scroller.nativeElement.style.marginRight = `${this.intervalCounter}vw`;
        this.intervalCounter++;
        if (this.intervalCounter % 25 == 0) {
          clearInterval(this.interRight)
