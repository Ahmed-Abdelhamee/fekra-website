...
export class DataService {
  ...
  createElection(data: any) {
    return this.http.post(`${this.Api_link}/api/Election/Addelection`, data).subscribe();
  }
  ...
  updateElection(id: number, data: any) {
    return this.http.put(`${this.Api_link}/api/Election/updateElection?id=${id}`, data).subscribe()
  }
  /* ------------------------------------------------------------------------------------------------------- */
